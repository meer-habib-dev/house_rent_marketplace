        ...
        <footer className='navbar'>
            <nav className='navbarNav'>
                <ul className='navbarListItems'>
                    ...
                    <li className='navbarListingItem' onClick={() => navigate('/offers')}> 
                    ...
                    <li className='navbarListingItem' onClick={() => navigate('/profile')}> 
                        <PersonalOutlineIcon fill={pathMatchRoute('/profile') ? '#2c2c2c' : '#8f8f8f'} width={'36px'} height={'36px'} />
